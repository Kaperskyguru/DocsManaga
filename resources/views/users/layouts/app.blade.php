...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="{{route('user')}}"><i class="menu-icon fa fa-dashboard" aria-hidden="true"></i>Dashboard </a>
                    </li>
                    <!-- /.menu-title -->
                    <li>
                        <a href="{{route('document')}}"> <i class="menu-icon fa fa-file" aria-hidden="true"></i>Documents</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    <div class="modal fade" id="generatedlinkModal" tabindex="-1" role="dialog" aria-labelledby="generatedlinkModalLabel" aria-hidden="true">
