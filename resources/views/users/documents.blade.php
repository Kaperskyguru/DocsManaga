                                    ...
                                    <table class="table" id="bootstrap-data-table-export1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> <span class="name">{{$trash->user->name}} </span></td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('documents')}}" id="addDocument1" method="post" enctype="multipart/form-data">
                    @csrf
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="addDocument1" class="btn btn-primary">Save</button>
            </div>
